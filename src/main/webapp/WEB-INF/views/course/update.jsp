									...
									<div class="card-body">
										<div class="row align-items-center">
											...
											<div class="col-md-11 pe-5">
												<input type="text" class="form-control w-25" name="title" id="title" placeholder="제목" value="${courseDto.title}">
											    <div>
											...
											<div class="col-md-11 pe-5">
												<select class="form-select w-25" name="category" id="category">
													<c:forEach var="category" items="${category}">
														<option value="${category.key}" ${courseDto.category eq category.key ? "selected":""}>${category.value}</option>
													</c:forEach>
												</select>
											    <div>
										...
										<div class="row align-items-center">
											...
											<div class="col-md-11 pe-5">
												<input type="number" class="form-control w-25" name="divclsNo" id="divclsNo" placeholder="분반" value="${courseDto.divclsNo}">
											</div>
										</div>
										<hr class="mx-n3">
										<div class="row align-items-center">
											...
											<div class="col-md-11 pe-5">
												<input type="text" class="form-control w-25" name="maxNum" id="maxNum" placeholder="최대인원" value="${courseDto.maxNum}">
												<div>
